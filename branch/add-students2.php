                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="addForm1" action="../php/controller/studentController.php"  enctype="multipart/form-data"  method="POST">
                                        <div class="container px-5">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" id="ccode" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" name="student_whatsapp_phone"
                                                        class="form-control valid" maxlength="10"
                                                        oninput="this.value = this.value.replace(/[^0-9]/g, '');"
                                                        required>
                                                </div>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-start gap-3 mt-4">
                                            <button type="submit" name="action" value="addStudent"
